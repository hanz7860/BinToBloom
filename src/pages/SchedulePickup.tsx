...
const SchedulePickup: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.wasteType || !formData.quantity || !formData.scheduledTime || !formData.location.address) {
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-lg">
          <div className="px-6 py-4 border-b border-gray-200">
            ...
            <p className="text-gray-600 mt-1">Schedule a convenient time for waste collection</p>
          </div>
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-green-700">
                  <ul className="list-disc list-inside space-y-1">
                    <li>Nearby collectors will be notified about your pickup request</li>
                    <li>A collector will accept your request and contact you</li>
                    <li>You'll receive notifications about the pickup status</li>
                    <li>The collector will arrive at your specified time and location</li>
                  </ul>
                </div>
              </div>
            </div>
