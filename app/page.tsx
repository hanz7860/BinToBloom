...
export default function Home() {
  ...
  const communityImpactInView = useInView(communityImpactRef, {
    once: true,
    amount: 0.3,
  })
          ...
          <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8 items-center relative z-10">
            ...
            >
              ...
              >
                ...
                <p className="text-xs mt-2 text-center drop-shadow-sm">
                  Food Waste
                </p>
              </motion.div>
              <motion.div
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-gray-600">
                  We convert waste into organic pesticides and distribute them
        ...
        >
          <div className="container mx-auto px-4">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={
                impactInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }
              }
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-3xl font-bold text-center text-gray-800 drop-shadow-md">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <motion.div
                initial={{ opacity: 0, y: 50 }}
                animate={
                  joinInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }
                }
                transition={{ duration: 0.6, delay: 0.2 }}
                whileHover={{ y: -10 }}
              ...
              >
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Donate your food waste and track your environmental impact
                </p>
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
              ...
              >
                ...
                <h3 className="font-semibold mb-2 drop-shadow-sm">
                  Restaurant
                </h3>
                <p className="text-sm text-gray-600 mb-4">
                  Schedule commercial pickups for your food waste
                </p>
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
              ...
              >
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Earn money by collecting waste in your neighborhood
                </p>
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
              ...
              >
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Partner with us to distribute organic pesticides
                </p>
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  <Button
                    ...
                    onClick={() =>
                      alert('NGO partnership program coming soon!')
                    }
                  >
                    Partner With Us
                  </Button>
        ...
        >
          <div className="container mx-auto px-4">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={
                ecoPointsInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }
              }
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-3xl font-bold text-center text-gray-800 drop-shadow-md">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                <h3 className="font-semibold mb-4 drop-shadow-sm">
                  Your Progress
                </h3>
                ...
                <div className="w-full bg-gray-200 rounded-full h-2 mb-6 shadow-inner">
                  <motion.div
                    initial={{ width: '0%' }}
                    animate={
                      ecoPointsInView ? { width: '75%' } : { width: '0%' }
                    }
              ...
              <motion.div
                initial={{ opacity: 0, y: 50 }}
                animate={
                  ecoPointsInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }
                }
                transition={{ duration: 0.6, delay: 0.3 }}
                className="bg-white p-6 rounded-lg shadow-xl hover:shadow-2xl transform hover:scale-105 hover:-translate-y-1 transition-all duration-300 border border-gray-100"
              >
              ...
              <motion.div
                initial={{ opacity: 0, x: 50 }}
                animate={
                  ecoPointsInView ? { opacity: 1, x: 0 } : { opacity: 0, x: 50 }
                }
                transition={{ duration: 0.6, delay: 0.4 }}
                className="bg-white p-6 rounded-lg shadow-xl hover:shadow-2xl transform hover:scale-105 hover:-translate-y-1 transition-all duration-300 border border-gray-100"
              >
        ...
        >
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <p className="text-center mb-12 text-green-100 drop-shadow-md">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              ...
              >
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={
                    communityImpactInView ? { opacity: 1 } : { opacity: 0 }
                  }
                  transition={{ duration: 1, delay: 0.4 }}
      ...
      >
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              >
                ...
                <span className="text-xl font-semibold text-green-500 drop-shadow-md">
                  BinToBloom
                </span>
              </motion.div>
              <p className="text-gray-400 text-sm mb-4 drop-shadow-sm">
                Innovative solutions for sustainable solutions for a greener
                tomorrow
              </p>
            ...
            <div>
              <h3 className="text-lg font-semibold mb-4 drop-shadow-md">
                Quick Links
              </h3>
              <ul className="space-y-2 text-gray-400">
                <motion.li whileHover={{ x: 5 }}>
                  <Link
                    href="#"
                    className="hover:text-green-500 transition-colors duration-200 hover:drop-shadow-sm"
                  >
                    How It Works
                  </Link>
                </motion.li>
          ...
          <div className="border-t border-gray-700 mt-12 pt-6 text-sm text-gray-400 text-center drop-shadow-sm">
            © 2024 BinToBloom. All rights reserved. Making the world greener,
